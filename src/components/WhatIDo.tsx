        ...
        <div className="what-box-in">
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <h4>Description</h4>
              <p>
                Specialized in building intelligent systems, fine-tuning models, and applying NLP techniques to solve real-world problems.
              </p>
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <h4>Description</h4>
              <p>
                Proficient in creating scalable full-stack applications, interactive UI, and robust backend systems.
              </p>
              <h5>Skillset & tools</h5>
              <div className="what-content-flex">
